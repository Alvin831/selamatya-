...
document.querySelectorAll('.wish-card, .photo-item, .video-item, .closing-card')
  .forEach(el => {
...
const playlist = [
  {
    src: 'music/Hindia - Cincin _ Lirik Lagu.mp3',
    title: 'Hindia — Cincin'
  },
  {
    src: 'music/Hindia - everything u are _ Lirik Lagu.mp3',
